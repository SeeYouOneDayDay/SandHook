...
public class StubMethodsFactory {
    ...
    static {
        try {
            //private static native java.lang.Class java.lang.reflect.Proxy.generateProxy(java.lang.String,java.lang.Class[],java.lang.ClassLoader,java.lang.reflect.Method[],java.lang.Class[][])
    ...
    public static synchronized Method getStubMethod() {
        ...
        Log.d("sanbo", "\r\n\t\t\t\tgetStubMethod.....curStub:" + curStub + "_____maxStub:" + maxStub);
        while (curStub <= maxStub) {
            try {
                Log.d("sanbo", "\r\n\t\t\t\tgetStubMethod.....proxyGenClass:" + proxyGenClass);
                Method m1 = StubMethodsFactory.class.getDeclaredMethod("stub" + curStub++);
                Log.d("sanbo", "\r\n\t\t\t\tgetStubMethod.....m1:" + m1);
                return m1;
        ...
        try {
            ...
            Log.d("sanbo", "\r\n\t\t\t\tgetStubMethod.....proxyGenClass:" + proxyGenClass);
            Method m2 = proxyClass.getDeclaredMethods()[0];
            Log.d("sanbo", "\r\n\t\t\t\tgetStubMethod.....m2:" + m2);
